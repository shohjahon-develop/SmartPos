...
from django.utils import timezone # salary_payment_date uchun
...
class UserProfile(models.Model):
    ...
    address = models.TextField(blank=True, null=True, verbose_name="Manzil") # Bu maydon allaqachon mavjud

    # YANGI QO'SHILDI: Oylik to'lanadigan sana
    salary_payment_date = models.DateField(null=True, blank=True, verbose_name="Oylik To'lanadigan Sana")

    salary_status_choices = [('Paid', 'Berilgan'), ('Pending', 'Kutilmoqda')]
...
def create_or_update_user_profile(sender, instance, created, **kwargs):
    ...
    # Agar mavjud userning profili yo'q bo'lsa (ehtimoldan yiroq, lekin himoya uchun)
    # elif not hasattr(instance, 'profile'):
    # UserProfile.objects.create(user=instance)
    # Agar user ma'lumotlari yangilansa va profilni ham sinxronlashtirish kerak bo'lsa:
    # else:
    #     try:
